/**
 * edgetunnel 2.1 - 订阅热补丁模块（Clash/Singbox 配置后处理）
 * Clash YAML 热补丁：DNS配置、gRPC User-Agent注入、ECH-opts注入
 * Singbox JSON 热补丁：DNS服务器迁移、规则集迁移、FakeIP、ECH/UTLS
 */
import { 替换星号为随机字符, 随机路径 } from './utils.js';
